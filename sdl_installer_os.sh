...
if [ -d ~/.brew ]
then
	echo -e "\033[33mbrew already installed.\033[00m\n"
else
	echo -e "\033[31minstalling brew...\033[00m"
...
echo -e "\033[31mbrew update :\033[00m"
brew update
echo ""
if [ -d ~/.brew/Cellar/sdl2 ]
then
	echo -e "\033[33msdl2 already installed.\033[00m"
else
	echo -e "\033[31minstalling sdl2...\033[00m"
	brew install sdl2
	echo ""
fi
if [ -d ~/.brew/Cellar/sdl2_image ]
then
	echo -e "\033[33msdl2_image already installed.\033[00m"
else
	echo -e "\033[31minstalling sdl2_image...\033[00m"
	brew install sdl2_image
	echo ""
fi
if [ -d ~/.brew/Cellar/sdl2_ttf ]
then
	echo -e "\033[33msdl2_ttf already installed.\033[00m"
else
	echo -e "\033[31minstalling sdl2_ttf...\033[00m"
	brew install sdl2_ttf
fi
if [ -d ~/.brew/Cellar/sdl2_mixer ]
then
	echo -e "\033[33msdl2_mixer already installed.\033[00m"
else
	echo -e "\033[31minstalling sdl2_mixer...\033[00m"
...
echo -e "\033[32mcopy all brew .a and .dylib in lib/sdl\033[00m"
